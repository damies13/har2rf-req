...
${_token}		59f19249911f738cd.cFhg90nCA3e4A7iluVI3dDF7Q1uVx2Txleo1bML2mts.AmoDtTr0Z0OVZNPD6WVjQWYSByzKrDWirL4AQbSXyaIGIladA5hIROlR3w
${username}		Admin
${password}		admin123
...
${Referer_6}		https://opensource-demo.orangehrmlive.com/web/index.php/leave/viewLeaveList
${fromDate}		2023-01-01
${toDate}		2023-12-31

*** Test Cases ***
orangehrm_1678956392
	Create Session    sess_opensource-demo_orangehrmlive_com 	https://opensource-demo.orangehrmlive.com 	disable_warnings=1
	orangehrm_1678956392 page@b45caa0474a7927d27057ef257203089
...
orangehrm_1678956392 page@b45caa0474a7927d27057ef257203089
	[Documentation] 	orangehrm_1678956392	|	orangehrm_1678956392 page@b45caa0474a7927d27057ef257203089	|	OrangeHRM
	...
	&{params_2}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	Accept=${Accept_1}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer}	Sec-Fetch-Dest=${Sec-Fetch-Dest_1}	Sec-Fetch-Mode=${Sec-Fetch-Mode_1}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_3}=		Create dictionary	${NoKey}
	...
	&{params_4}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	Accept=${Accept_2}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer}	Sec-Fetch-Dest=${Sec-Fetch-Dest_2}	Sec-Fetch-Mode=${Sec-Fetch-Mode_1}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_5}=		Create dictionary	${NoKey}
	...
	&{params_7}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	Accept=${Accept_4}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer}	Sec-Fetch-Dest=${Sec-Fetch-Dest_4}	Sec-Fetch-Mode=${Sec-Fetch-Mode_1}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_8}=		Create dictionary	${NoKey}
	...
	&{params_17}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_3}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_18}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_3}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_19}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_3}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_20}=		Create dictionary	${NoKey}
	...
	&{params_26}=		Create dictionary	${NoKey}
	...
	&{params_27}=		Create dictionary	${NoKey}
	...
	${resp_28}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-700.woff2	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_29}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-italic.woff2	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	Accept=${Accept_4}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_3}	Sec-Fetch-Dest=${Sec-Fetch-Dest_4}	Sec-Fetch-Mode=${Sec-Fetch-Mode_1}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_30}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Accept=${Accept_3}	Cache-Control=${Cache-Control_1}	Referer=${Referer_3}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_39}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/dashboard/employees/locations	headers=${Req_Headers}	expected_status=-1
	...
	${resp_40}=		POST On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/events/push	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	Accept=${Accept}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_3}	Sec-Fetch-Dest=${Sec-Fetch-Dest}	Sec-Fetch-Mode=${Sec-Fetch-Mode}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	Sec-Fetch-User=${Sec-Fetch-User}	Upgrade-Insecure-Requests=${Upgrade-Insecure-Requests}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_43}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-700.woff	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_44}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-italic.woff	headers=${Req_Headers}	expected_status=-1
	...
	&{params_45}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_46}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_47}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_48}=		Create dictionary	${NoKey}
	...
	&{params_54}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_55}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_56}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_58}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-italic.woff2	headers=${Req_Headers}	expected_status=-1
	...
	${resp_60}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/admin/employment-statuses	headers=${Req_Headers}	expected_status=-1	params=${params_60}
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Accept=${Accept_3}	Cache-Control=${Cache-Control_1}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_61}=		Create dictionary	limit=${limit_2}
	${resp_61}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/admin/job-titles	headers=${Req_Headers}	expected_status=-1	params=${params_61}
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Accept=${Accept_3}	Cache-Control=${Cache-Control_1}	Referer=${Referer_4}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_62}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/admin/subunits	headers=${Req_Headers}	expected_status=-1
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_64}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-700.woff2	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_65}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-italic.woff	headers=${Req_Headers}	expected_status=-1
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_2}	Origin=${Origin}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_66}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/dist/fonts/nunito-sans-v6-latin-ext_latin-700.woff	headers=${Req_Headers}	expected_status=-1
	&{params_67}=		Create dictionary	${NoKey}
	...
	&{params_68}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_5}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_69}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_5}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_70}=		Create dictionary	${NoKey}
	...
	&{params_76}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_5}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_77}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_5}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_78}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	Accept=${Accept}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_5}	Sec-Fetch-Dest=${Sec-Fetch-Dest}	Sec-Fetch-Mode=${Sec-Fetch-Mode}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	Sec-Fetch-User=${Sec-Fetch-User}	Upgrade-Insecure-Requests=${Upgrade-Insecure-Requests}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_85}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/leave/viewLeaveModule	headers=${Req_Headers}	expected_status=302	allow_redirects=${False}
	&{Req_Headers}=		Create dictionary	Accept=${Accept}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_5}	Sec-Fetch-Dest=${Sec-Fetch-Dest}	Sec-Fetch-Mode=${Sec-Fetch-Mode}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	Sec-Fetch-User=${Sec-Fetch-User}	Upgrade-Insecure-Requests=${Upgrade-Insecure-Requests}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_86}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/leave/viewLeaveList	headers=${Req_Headers}	expected_status=200
	...
	&{params_87}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_6}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_88}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_6}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_89}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_6}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_90}=		Create dictionary	${NoKey}
	...
	&{params_98}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_6}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_99}=		Create dictionary	${NoKey}
	...
	&{Req_Headers}=		Create dictionary	sec-ch-ua=${sec-ch-ua}	Referer=${Referer_6}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	User-Agent=${User-Agent}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_100}=		Create dictionary	${NoKey}
	...
	&{params_102}=		Create dictionary	limit=${limit_1}	offset=${offset}	includeEmployees=${includeEmployees}
	${resp_102}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/employees/leave-requests	headers=${Req_Headers}	expected_status=200	params=${params_102}
	&{Req_Headers}=		Create dictionary	Accept=${Accept_5}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	${resp_103}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/leave-periods	headers=${Req_Headers}	expected_status=200
	&{Req_Headers}=		Create dictionary	Accept=${Accept_5}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_104}=		Create dictionary	model=${model_1}
	${resp_104}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/workweek	headers=${Req_Headers}	expected_status=200	params=${params_104}
	&{Req_Headers}=		Create dictionary	Accept=${Accept_5}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	...
	&{Req_Headers}=		Create dictionary	Accept=${Accept_3}	Accept-Language=${Accept-Language}	Cache-Control=${Cache-Control_1}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_106}=		Create dictionary	limit=${limit_2}
	${resp_106}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/leave-types	headers=${Req_Headers}	expected_status=200	params=${params_106}
	&{Req_Headers}=		Create dictionary	Accept=${Accept_5}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_107}=		Create dictionary	fromDate=${fromDate}	toDate=${toDate}
	${resp_107}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/holidays	headers=${Req_Headers}	expected_status=200	params=${params_107}
	&{Req_Headers}=		Create dictionary	Accept=${Accept_5}	Accept-Language=${Accept-Language}	Connection=${Connection}	Host=${Host}	Referer=${Referer_6}	Sec-Fetch-Dest=${Sec-Fetch-Dest_3}	Sec-Fetch-Mode=${Sec-Fetch-Mode_2}	Sec-Fetch-Site=${Sec-Fetch-Site_1}	User-Agent=${User-Agent}	sec-ch-ua=${sec-ch-ua}	sec-ch-ua-mobile=${sec-ch-ua-mobile}	sec-ch-ua-platform=${sec-ch-ua-platform}
	&{params_108}=		Create dictionary	fromDate=${fromDate}	toDate=${toDate}
	${resp_108}=		GET On Session		sess_opensource-demo_orangehrmlive_com		url=/web/index.php/api/v2/leave/holidays	headers=${Req_Headers}	expected_status=200	params=${params_108}
